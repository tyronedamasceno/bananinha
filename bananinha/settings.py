"""
Django settings for bananinha project.
...
WSGI_APPLICATION = 'bananinha.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './bananinha.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
